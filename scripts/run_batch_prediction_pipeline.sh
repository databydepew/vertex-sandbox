...
PIPELINE_ROOT=gs://vertex-demo-pipeline-depew/pipeline_root # The GCS path for storing artifacts of pipeline runs
DATA_PIPELINE_ROOT=gs://vertex-demo-pipeline-depew/compute_root # The GCS staging location for custom job
GCS_OUTPUT_PATH=gs://vertex-demo-pipeline-depew/datasets/prediction # The GCS path for storing processed data
GCS_PREDICTION_PATH=gs://vertex-demo-pipeline-depew/prediction # The GCS path for storing prediction results
...
ENDPOINT_RN='projects/297370817971/locations/us-central1/endpoints/8843521555783745536'
